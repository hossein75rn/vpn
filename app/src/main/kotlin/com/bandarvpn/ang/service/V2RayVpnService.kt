package com.bandarvpn.ang.service
...
import com.bandarvpn.ang.dto.ERoutingMode
import com.bandarvpn.ang.util.MmkvManager
import com.bandarvpn.ang.util.MyContextWrapper
...
//        saveVpnNetworkInfo(configName, info)
        ...
        if (isForced) {
            //stopSelf has to be called ahead of mInterface.close(). otherwise bandarvpn core cannot be stooped
            //It's strage but true.
            //This can be verified by putting stopself() behind and call stopLoop and startLoop
            //in a row for several times. You will find that later created bandarvpn core report port in use
            //which means the first bandarvpn core somehow failed to stop and release the port.
            stopSelf()
